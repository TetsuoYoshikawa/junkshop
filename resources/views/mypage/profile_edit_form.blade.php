                ...
                <form method="POST" action="{{ route('mypage.edit-profile') }}" class="p-5" enctype="multipart/form-data">
                    ...
                    <span class="avatar-form image-picker">
                        ...
                        <label for="avatar" class="d-inline-block">
                            ...
                            <img src="https://tetsuoyoshikawa.s3.ap-northeast-3.amazonaws.com/avatars/{{$user->avatar_file_name}}" class="rounded-circle" style="object-fit: cover; width: 200px; height: 200px;">
                        @else
