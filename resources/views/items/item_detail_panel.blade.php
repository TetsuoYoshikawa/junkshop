...
<div class="row">
    <div class="col-4 offset-1">
        <img class="card-img-top" src="https://tetsuoyoshikawa.s3.ap-northeast-3.amazonaws.com/item-image/{{$item->image_file_name}}">
    </div>
    <div class="col-6">
            ...
            <tr>
                ...
                <td>
                    @if (!empty($item->seller->avatar_file_name))
                        <img src="https://tetsuoyoshikawa.s3.ap-northeast-3.amazonaws.com/avatars/{{$item->seller->avatar_file_name}}" class="rounded-circle" style="object-fit: cover; width: 35px; height: 35px;">
                    @else
